...
public class ActiveMqUtil {
	public static void senderMessage(String message) {
		...
		// 构造ConnectionFactory
		connectionFactory = new org.apache.activemq.ActiveMQConnectionFactory(ActiveMQConnection.DEFAULT_USER,
		...
		try {
			...
			// 获取服务商的消息
			destination = session.createQueue("ZDYQUEUE");
			// 得到消息的发送者
	...
	public static void sendMessage(Session session, MessageProducer messageProducer, String messages)
			throws JMSException {
